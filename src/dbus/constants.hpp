...
inline constexpr std::string_view STATUS_INTERFACE_NAME =
    "org.lamellix.vAuth.Status1";
inline constexpr std::string_view HAS_AVAILABLE_AGENT_METHOD =
    "HasAvailableAgent";
...
inline constexpr std::string_view RESPOND_TO_PRESENCE_METHOD =
    "RespondToPresence";
inline constexpr std::string_view SUBMIT_SECRET_METHOD = "SubmitSecret";
